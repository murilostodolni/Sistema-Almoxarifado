...
public class AlterarProdutoController {
	...
	public void buscarProduto() {
		try {
			...
			produto = ProdutoDAO.getInstance().buscar(codigoProduto);

			txtDescricao.setText(produto.getNomeProduto());
			txtValor.setText(Double.toString(produto.getValorProduto()));
	...
	public void selecionarProduto() {
		produto = tblListaProdutos.getSelectionModel().getSelectedItem();
		txtDescricao.setText(produto.getNomeProduto());
		txtValor.setText(Double.toString(produto.getValorProduto()));
	}
	...
	public void alterar() {
		...
		alerta.setHeaderText("Produto alterado com sucesso!");
		alerta.show();
